...
const CreateUserDialog: React.FC<CreateUserDialogProps> = ({
  ...
  return (
    <Dialog
      ...
      maxWidth={'sm'}
    >
      <DialogTitle>Start Creating Task Workflows</DialogTitle>
      <DialogContent>
        <Typography variant="body1">
          To start creating task workflows, you need a username so that your
          workflows can be attributed to you.
        </Typography>
        <TextField
          label="Username"
          value={username}
