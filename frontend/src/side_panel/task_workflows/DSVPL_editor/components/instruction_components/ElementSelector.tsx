...
import { urlsMatch } from '../../task_workflow_utils/elementUtils';
import { getSection } from '../../../unpublished_task_workflow_reducer/getters/nodes';
...
const ElementSelector: React.FC<ElementSelectorProps> = ({ step }) => {
  const { dispatch, unpublishedWorkflow } = useUnpublishedWorkflowContext();
  const { tab } = useTabContext();

  const [openEditDialog, setOpenEditDialog] = useState(false);
  const section = getSection(step.id.parentId, unpublishedWorkflow.program);
