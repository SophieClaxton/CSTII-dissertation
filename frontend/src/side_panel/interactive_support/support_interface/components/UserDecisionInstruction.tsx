...
import { WorkflowLocation } from '../../../models/support_and_MII/UserSupport';
...
interface UserDecisionInstructionProps {
  ...
  currentWorkflowLocation: StateRef<WorkflowLocation>;
}
  ...
  return (
    ...
    >
      ...
      <Button
        ...
        onClick={() => {
          currentWorkflowLocation.current = {
            stepNumber: currentWorkflowLocation.current.stepNumber + 1,
            decisionHistory: [
              ...currentWorkflowLocation.current.decisionHistory,
              'yes',
            ],
          };
